...
Using Pip:
``` bash
pip install "malaya-tagging-pipeline @ git+https://github.com/UCREL/malaya-tagging-pipeline"
```

Using UV:
``` bash
uv add "malaya-tagging-pipeline" git+https://github.com/UCREL/malaya-tagging-pipeline
```
