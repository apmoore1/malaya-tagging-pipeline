# Malaya Tagging Pipeline GitHub and PyPI Release Process
...
to `git@github.com:UCREL/malaya-tagging-pipeline.git` (or the `HTTPS` equivalent). To check: `git remote -v`
